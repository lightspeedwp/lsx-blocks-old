...
const { Button, Dashicon, Button } = wp.components;
	...
	render() {
		...
		return [
			...
			<CardBox key="card" {...this.props}>
				...
				<div className={classnames("lsx-card-column lsx-card-content-wrap")}>
					<RichText
						tagName="p"
					...
					<RichText
						tagName="div"
						className={classnames("lsx-card-text")}
						style={{
					...
					<RichText
						tagName="div"
						className={classnames("lsx-card-footer")}
						style={{
...
registerBlockType("lsx-blocks/lsx-card-box", {
	...
	icon: "images-alt",
	category: "lsx-blocks",
	keywords: [__("card", "lsx-blocks"), __("lsx", "lsx-blocks")],
			...
			save: function(props) {
				...
				return (
					...
					<CardBox {...props}>
						...
						<div
							className={classnames("lsx-card-column lsx-card-content-wrap")}
						>
							{cardName && (
								<RichText.Content
									tagName="h2"
